...
public class ForwardChatMessageAdapter extends RecyclerView.Adapter<ForwardChatMessageAdapter.StatusViewHolder> {
    private Context context;
    private ArrayList<Followers> followers;
    public static MessageForwardClickListener forwardClickListener;

    public ForwardChatMessageAdapter(Context context, ArrayList<Followers> followers) {
    ...
    public StatusViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(this.context).inflate(R.layout.forward_chat_users_custom_row,viewGroup,false);
...
//       }
        ...
        public StatusViewHolder(@NonNull View itemView, final Context context, final ArrayList<Followers> followers) {
            ...
            sendBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    forwardClickListener.onMessageForwardButtonClicked(user_id,sendBtn);
                }
            });
        }
    }
    ...
    public interface MessageForwardClickListener {
        void onMessageForwardButtonClicked(int followed_user_id,Button button);
    }

    public void setOnMessageForwardClickListener(MessageForwardClickListener onMessageForwardClickListener){
        forwardClickListener = onMessageForwardClickListener;
    }
}
