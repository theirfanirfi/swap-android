...
public class InviteToGroupAdapter extends RecyclerView.Adapter<InviteToGroupAdapter.StatusViewHolder> {
    private Context context;
    private ArrayList<Followers> followers;
    public static InviteClickListener inviteClickListener;

    public InviteToGroupAdapter(Context context, ArrayList<Followers> followers) {
    ...
    public StatusViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(this.context).inflate(R.layout.invite_to_group_custom_row,viewGroup,false);
...
//       }
    ...
    public interface InviteClickListener {
        void onInvite(int followed_user_id, Button button);
    }

    public void setOnInviteClickListener(InviteClickListener inviteListener){
        inviteClickListener = inviteListener;
    }
}
