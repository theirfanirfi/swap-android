...
public class ForwardMessageActivity extends AppCompatActivity implements ForwardChatMessageAdapter.MessageForwardClickListener {

    private Toolbar toolbar;
    private RecyclerView sWRV;
    private ForwardChatMessageAdapter forwardChatAdapter;
...
//        });
        ...
        forwardChatAdapter = new ForwardChatMessageAdapter(context,followersList);
        forwardChatAdapter.setOnMessageForwardClickListener(this);


        sWRV = findViewById(R.id.swapWithRV);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(getApplicationContext());
        sWRV.setLayoutManager(layoutManager);
        sWRV.setAdapter(forwardChatAdapter);
                    ...
                    if(followers.getAuthenticated()){
                        if(followers.getFound()){
                            if(followers.getFollowersFound()){
                                ...
                                forwardChatAdapter.FilterRV(followersList);
                            }else {
...
//                sWRV.setAdapter(swapWithAdapter);
    ...
    private void filter(String s) {
        ...
        forwardChatAdapter.FilterRV(filteredArrayList);
    ...
    @Override
    public void onMessageForwardButtonClicked(final int followed_user_id, final Button button) {
